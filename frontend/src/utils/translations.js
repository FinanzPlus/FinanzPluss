 ...
 * Fichier centralisé des traductions pour FinanzPlus Austria
 */
...
export const translations = {
  ...
  loan: {
    ...
    effectiveRate: 'Effektiver Jahreszins',
    ...
    simulator: 'Kreditrechner',
    comparator: 'Kreditvergleich',
    request: 'Kreditanfrage',
    approval: 'Kreditgenehmigung',
  ...
  documents: {
    ...
    approved: 'Genehmigt',
    rejected: 'Abgelehnt',
    required: 'Erforderliche Dokumente',
    optional: 'Optionale Dokumente',
    dragDrop: 'Dateien hier ablegen oder klicken zum Hochladen',
  ...
  appointments: {
    ...
    cancelSuccess: 'Termin erfolgreich abgesagt',
    cancelConfirm: 'Möchten Sie diesen Termin wirklich absagen?',
    types: {
      consultation: 'Erstberatung',
      detailed: 'Detailberatung',
      signing: 'Vertragsabschluss',
  ...
  success: {
    ...
    confirmed: 'Erfolgreich bestätigt',
  ...
  footer: {
    ...
    copyright: '© {year} FinanzPlus Austria GmbH. Alle Rechte vorbehalten.',
  ...
  cookies: {
    ...
    functionalDesc: 'Ermöglichen erweiterte Funktionen',
    analyticsDesc: 'Helfen uns, die Website zu verbessern',
    marketingDesc: 'Für personalisierte Werbung',
    learnMore: 'Mehr erfahren',
