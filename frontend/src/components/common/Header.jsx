    ...
    <header className={`header ${isScrolled ? 'header-scrolled' : ''}`}>
      <div className="header-container">
        ...
        <Link to="/" className="header-logo">
          ...
          <div className="logo-text">
            <span className="logo-name">FinanzPlus</span>
        ...
        <nav className="header-nav desktop-nav">
          ...
          <Link to="/kontakt" className={`nav-link ${isActive('/kontakt')}`}>
            📞 Kontakt
          </Link>
        </nav>
        ...
        <div className="header-actions desktop-actions">
          {/* Badge SSL */}
          <div className="ssl-badge" title="Sichere SSL-Verschlüsselung">
            🔒 SSL
          </div>
      ...
      <div className={`mobile-menu ${isMobileMenuOpen ? 'open' : ''}`}>
        <nav className="mobile-nav">
          ...
          <Link to="/kontakt" className={`mobile-nav-link ${isActive('/kontakt')}`}>
            📞 Kontakt
          </Link>
