...
const WhatsAppButton = () => {
  ...
  // Afficher le tooltip automatiquement après 3 secondes
  useEffect(() => {
    if (isVisible) {
  ...
  const handleClick = () => {
    const whatsappNumber = import.meta.env.VITE_WHATSAPP_NUMBER || '+4368110535900';
    ...
    <div className={`whatsapp-float ${isVisible ? 'visible' : ''}`}>
      ...
      <div className={`whatsapp-tooltip ${showTooltip ? 'show' : ''}`}>
        ...
        <p className="tooltip-text">
          ...
          Chatten Sie jetzt mit uns auf WhatsApp!
        </p>
      </div>
      ...
      >
        ...
        {/* Cercles d'animation pulsante */}
        <span className="whatsapp-pulse"></span>
        <span className="whatsapp-pulse whatsapp-pulse-2"></span>
      </button>
    </div>
  );
};
